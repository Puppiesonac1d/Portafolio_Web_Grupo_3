...
SET DEFINE OFF;
Insert into PORTAFOLIO.USUARIOS (IDUSUARIO,CORREO,CONTRASENA,RUT,NOMBRE,APPATERNO,APMATERNO,FEC_CREACION,IDTIPOUSUARIO) values ('1','ADMINISTRADOR@ADMIN.CL','admin','17.413.056-2','Diego','González','Román',to_timestamp('11/12/19 21:01:09,120000000','DD/MM/RR HH24:MI:SSXFF'),'1');
Insert into PORTAFOLIO.USUARIOS (IDUSUARIO,CORREO,CONTRASENA,RUT,NOMBRE,APPATERNO,APMATERNO,FEC_CREACION,IDTIPOUSUARIO) values ('2','DGONZALEZ@USUARIOS.CL','usuario','19.413.056-2','Diego','González','Román',to_timestamp('11/12/19 21:01:09,120000000','DD/MM/RR HH24:MI:SSXFF'),'3');
Insert into PORTAFOLIO.USUARIOS (IDUSUARIO,CORREO,CONTRASENA,RUT,NOMBRE,APPATERNO,APMATERNO,FEC_CREACION,IDTIPOUSUARIO) values ('3','DGONZALEZ2@USUARIOS.CL','usuario','20.413.056-2','Diego','González','Román',to_timestamp('11/12/19 21:01:09,120000000','DD/MM/RR HH24:MI:SSXFF'),'2');
